        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: const [
                _AppBar(),
                // Reduced vertical padding in b_HeroSection and the SizedBox before _StatsSection
                _HeroSection(),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // The AuthWrapper in main.dart will automatically show the login screen
              },
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              // Keep only "Sign Up" and "Logout" to reduce AppBar width
              _ModernAppBarButton(
                text: 'Sign Up',
                gradient: LinearGradient(
...
// Modern gradient button widget for the AppBar
...
// The main hero section with modern gradient overlay and enhanced styling
class _HeroSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      // Removed fixed height here, letting content define height
...
// Modern gradient button widget for the hero section
...
// Enhanced stats section with modern card design
...
// Modern statistic item with gradient card design
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GridView.count(
        ...
        mainAxisSpacing: 16,
        childAspectRatio:
            0.85, // Adjust aspect ratio for better fit with 7 cards
        children: [
          _FeatureCard(
            icon:
                Icons.track_changes, // Placeholder for Carbon Footprint Tracker
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CarbonTrackerPage()),
              );
            },
          ),
          _FeatureCard(
            icon: Icons.shopping_cart, // Placeholder for Eco-Friendly Products
          ...
          _FeatureCard(
            icon: Icons.restaurant_menu, // Placeholder for Educational Content
          ...
          _FeatureCard(
            icon:
                Icons.emoji_events, // Placeholder for Sustainability Challenges
          ...
          _FeatureCard(
            icon: Icons.recycling, // Placeholder for Waste Reduction Tips
            title: 'Waste Reduction Tips',
            description: 'Learn practical ways to reduce, reuse, and recycle.',
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
          ...
          _FeatureCard(
            icon: Icons.people, // Placeholder for Community Support
...
// Modern feature card with gradient design and enhanced styling
